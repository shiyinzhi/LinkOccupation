...
/**
 * 套餐服务订单信息ServiceOrdersMineQueryDto
 * @author shiyinzhi
 */
@ApiModel(value = "套餐服务订单信息ServiceOrdersMineQueryDto", description = "套餐服务订单信息ServiceOrdersMineQueryDto")
public class ServiceOrdersMineQueryDto {
