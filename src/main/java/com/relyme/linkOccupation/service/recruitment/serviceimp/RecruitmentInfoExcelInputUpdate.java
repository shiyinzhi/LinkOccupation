...
@Component
public class RecruitmentInfoExcelInputUpdate extends ExcelInputDecotator {
    ...
    @Autowired
    RecruitmentInfoExcelInputImp recruitmentInfoExcelInputImp;

    public RecruitmentInfoExcelInputUpdate(@Qualifier("recruitmentInfoExcelInputImp") ExcelInputAbstractService excelInputAbstractService) {
