...
/**
 * 法律咨询管理LegalConsultingQueryDto
 * @author shiyinzhi
 */
@ApiModel(value = "法律咨询管理LegalConsultingQueryDto", description = "法律咨询管理LegalConsultingQueryDto")
public class LegalConsultingQueryDto {
