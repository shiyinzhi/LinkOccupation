...
/**
 * 任务分配MissionDeliverDto
 * @author shiyinzhi
 */
@ApiModel(value = "任务分配MissionDeliverDto", description = "任务分配MissionDeliverDto")
public class MissionDeliverDto {
     ...
     * 接单状态 1录用 2未录用
     */
    @ApiModelProperty("接单状态 1录用 2未录用")
