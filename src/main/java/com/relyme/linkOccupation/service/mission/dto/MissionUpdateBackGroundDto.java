...
/**
 * 任务信息MissionUpdateBackGroundDto
 * @author shiyinzhi
 */
@ApiModel(value = "任务信息MissionUpdateBackGroundDto", description = "任务信息MissionUpdateBackGroundDto")
public class MissionUpdateBackGroundDto {
