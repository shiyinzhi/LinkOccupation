...
/**
 * 任务信息MissionRecordViewQueryDto
 * @author shiyinzhi
 */
@ApiModel(value = "任务信息MissionRecordViewQueryDto", description = "任务信息MissionRecordViewQueryDto")
public class MissionRecordViewQueryDto {
