...
/**
 * 企业雇主信息EnterpriseInfoExportQueryDto
 * @author shiyinzhi
 */
@ApiModel(value = "企业雇主信息EnterpriseInfoExportQueryDto", description = "企业雇主信息EnterpriseInfoExportQueryDto")
public class EnterpriseInfoExportQueryDto {
