...
/**
 * 企业信息IndividualEmployersExportQueryDto
 * @author shiyinzhi
 */
@ApiModel(value = "企业信息IndividualEmployersExportQueryDto", description = "企业信息IndividualEmployersExportQueryDto")
public class IndividualEmployersExportQueryDto {
